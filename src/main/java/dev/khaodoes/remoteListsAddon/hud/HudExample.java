package dev.khaodoes.remoteListsAddon.hud;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(RemoteListsAddon.HUD_GROUP, "example", "HUD element example.", HudExample::new);
