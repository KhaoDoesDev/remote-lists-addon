package dev.khaodoes.remoteListsAddon.modules;
...
public class ModuleExample extends Module {
    ...
    public ModuleExample() {
        super(RemoteListsAddon.CATEGORY, "world-origin", "An example module that highlights the center of the world.");
    }

    /**
     * Example event handling method.
     * Requires {@link RemoteListsAddon#getPackage()} to be setup correctly, otherwise the game will crash whenever the module is enabled.
     */
    @EventHandler
